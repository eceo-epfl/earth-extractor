...
from enums import Satellites, ROI
...
def show_providers(
    ...
    no_confirmation: bool = typer.Option(False, "--no-confirmation",
    ...
    print("The output files are located at:")
